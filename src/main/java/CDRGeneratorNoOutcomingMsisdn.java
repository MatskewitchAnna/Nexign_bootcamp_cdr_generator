...
public class CDRGeneratorNoOutcomingMsisdn {
    ...
    public static void main(String[] args) {
        ...
        try (FileWriter writer = new FileWriter("cdr_no_outcoming_msisdn.txt")) {
            for (int i = 0; i < 10; i++) {
                generateCallData(writer, 1, 60);
            }

            System.out.println("Генерация тестовых данных с отсутствующим номером вызывающего абонента завершена. Записи сохранены в cdr_no_outcoming_msisdn.txt.");
